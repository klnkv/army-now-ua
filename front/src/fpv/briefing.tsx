    ...
    <div className="pointer-events-none absolute inset-0 z-20 flex items-center justify-center overflow-x-hidden p-3 md:p-8">
      <div className="pointer-events-auto hud-panel hud-corners max-h-full w-full min-w-0 max-w-xl overflow-hidden bg-ink/88 p-5 md:p-8">
        ...
        <div className="flex min-w-0 items-center gap-3 md:gap-4">
          <DroneGlyph className="h-14 w-16 shrink-0 text-chalk md:h-20 md:w-24" />
        ...
        {onExit ? (
          <button
            ...
            className="mt-2 w-full border border-chalk/40 px-4 py-3 font-hud text-xs tracking-[0.24em] text-chalk-dim"
          >
            ШТАБ
          </button>
        ) : null}
...
export function ResultOverlay({ onExit }: { onExit?: (result: "hit" | "miss" | "crash" | "timeout") => void }) {
      ...
      {show ? (
        <div className="pointer-events-auto hud-panel hud-corners w-full max-w-md bg-ink/90 p-6 text-center">
          ...
          <button
            ...
            className="mt-6 w-full border border-chalk bg-chalk/10 px-4 py-3 font-display tracking-[0.24em]"
          >
            ДО ШТАБУ
          </button>
          <button
